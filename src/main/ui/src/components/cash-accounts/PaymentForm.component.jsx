...
function PaymentForm({ parentSubmitHandler }) {
  ...
  let submitHandler = (e) => {
    ...
    const data = {
      ...
      destinationEntity: inputDestinationEntity.current.value,
      ...
      <form align="center" onSubmit={submitHandler} className={classes.root}>
        ...
        <div>
          <TextField
            ...
            inputRef={inputDestinationEntity}
          />
        </div>
        <div>
